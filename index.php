...
<title>G H Raisoni Exam System </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">G H Raisoni Exam System</span></div>
...
<div class="modal-body">
		...
		<div class="row">
		<div class="col-md-7">
<img src="image/ghrcem1.jpg" width=1200 height=500 alt="Gaurav Sonawane" class="img-rounded">
</div>
<div class="row">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/colleges.png" width=100 height=100 alt="Gaurav Lalitkumar Sonawane" class="img-rounded">
		 </div>
		 <div class="col-md-5">
    <h4 style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Gaurav Lalitkumar Sonawane</h4>
    <h4 style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Darshan Anil Patil</h4>
    <h4 style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Ajinkya Shivaji Kardile</h4>
    <h4 style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Deepak Hanuman Gondkar</h4>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1"></h4>
		<h4 style="font-family:'typo' "></h4>
		<h4 style="font-family:'typo' ">G H Raisoni College of Engineering & Management Pune</h4></div></div>
		</p>
      </div>
